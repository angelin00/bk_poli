...
<html lang="en">
  ...
  <body>
  <nav class="navbar fixed-top navbar-expand-lg py-3 navbar-dark" style="background-color:		#DB7093;">
    ...
    if (isset($_GET['page'])) {
        ...
        if (isset($_SESSION['username'])) {
            ...
            echo "</h2><hr>Silakan Login. Jika belum memiliki akun silakan Register terlebih dahulu.";
        }
    }
    ?>
    </main>
